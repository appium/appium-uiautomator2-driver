...
screen-reader-focusable | Whether the element is explicitly marked as a focusable unit by a screen reader | 'true'
...
drawing-order | The drawing position of the view corresponding to this element relative to its siblings | '3'
showing-hint | Whether the element's text represents a hint for the user to enter text | 'true'
text-entry-key | Whether the element represents a text entry key that is part of a keyboard or keypad | 'true'
...
heading | Whether element represents a heading | 'true'
...
context-clickable | Whether this element is context clickable | 'true'
...
pane-title | Title of the pane represented by this element | 'text string'
