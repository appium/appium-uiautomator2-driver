...
extensions.executeMobile = async function (mobileCommand, opts = {}) {
  const mobileCommandsMapping = {
    ...
    uiautomatorViewer: 'mobileUiautomatorViewer',
  };
...
/**
 * Opens the UiautomatorViewer
 */
commands.mobileUiautomatorViewer = async function mobileUiautomatorViewer () {
  const uiautomatorViewerBin = path.join(process.env.ANDROID_HOME, 'tools', 'bin', 'uiautomatorviewer');
  await exec(uiautomatorViewerBin);
};
