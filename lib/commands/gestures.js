 ...
 * @property {?Point} offset - The coordinates to click on
 ...
 * @property {?Point} start - The starting coordinates where the dragging starts
 * @property {!Point} end - The ending coordinates where the dragging ends
 ...
 * @property {?Rect} area - The fling bounding area
...
commands.mobileFlingGesture = async function mobileFlingGesture (opts = {}) {
  ...
  return await this.uiautomator2.jwproxy.command('/appium/gestures/fling', 'POST', {
    origin: toOrigin(elementId),
    area: toRect(startX, startY, width, height),
    direction,
    speed,
  });
};
 ...
 * area is effectively ignored.
 * @property {?Rect} area - The pinch bounding area
 ...
 * area is effectively ignored.
 * @property {?Rect} area - The swipe bounding area
 ...
 * area is effectively ignored.
 * @property {?Rect} area - The scroll bounding area
