...
class AndroidUiautomator2Driver extends BaseDriver {
  constructor (opts = {}, shouldValidateCaps = true, driverArgs = {}) {
    ...
    delete opts.shell;
    opts.reboot = helpers.parseReboot(driverArgs);
    opts.suppressKillServer = helpers.parseSuppressKillServer(driverArgs);
    opts.chromeDriverPort = helpers.parseChromeDriverPort(driverArgs);
    opts.chromedriverExecutable = helpers.parseChromedriverExecutable(driverArgs);
