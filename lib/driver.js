...
// Import a function only avaible in @appium/base-driver
// Note: this is a special use-case, once this driver only supports appium 2.0,
// then we can migrate all imports to the @appium/base-driver package
import { parseServerArgs } from '@appium/base-driver';
import { ARGS_CONSTRAINTS } from './constraints';
...
class AndroidUiautomator2Driver extends BaseDriver {
  constructor (opts = {}, shouldValidateCaps = true, driverArgs = {}) {
    ...
    delete opts.shell;
    opts = parseServerArgs(opts, driverArgs, Object.keys(ARGS_CONSTRAINTS), ARGS_CONSTRAINTS);
