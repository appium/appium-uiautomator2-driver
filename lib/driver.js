...
class AndroidUiautomator2Driver extends BaseDriver {
  ...
  async startUiAutomator2Session () {
    ...
    if (this.opts.app || (this.opts.appPackage && this.opts.appActivity)) {
    ...
    if (this.opts.appInfo && !this.caps.appPackage) {
      this.caps.appPackage = this.opts.appInfo.appPackage;
    }
    ...
    if (this.opts.appInfo || this.caps.appPackage) {
      ...
      // Remove app package et al if none started
      delete this.caps.appPackage;
      delete this.caps.appActivity;
    }
