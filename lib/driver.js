...
const NO_PROXY = [
  ...
  ['GET', new RegExp('^/session/[^/]+/stat_bar_height')],
  ['GET', new RegExp('^/session/[^/]+/device_pixel_ratio')],
  ['GET', new RegExp('^/session/[^/]+/viewport_screenshot')],
  ['GET', new RegExp('^/session/[^/]+/is_scrollable')],
  ['GET', new RegExp('^/session/[^/]+/scrollable_view_size')],
  ['POST', new RegExp('^/session/[^/]+/definite_scrolling')],
  ['GET', new RegExp('^/session/[^/]+/first_visible_item_id')],
  ['POST', new RegExp('^/session/[^/]+/scroll_to_id')]
];
