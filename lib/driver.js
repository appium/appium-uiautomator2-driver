...
const NO_PROXY = [
  ...
  ['GET', new RegExp('^/session/[^/]+/appium/device/stat_bar_height')],
  ['GET', new RegExp('^/session/[^/]+/appium/device/pixel_ratio')],
  ['GET', new RegExp('^/session/[^/]+/viewport_screenshot')],
  ['GET', new RegExp('^/session/[^/]+/appium/element/:elementId/content_size')],
  ['GET', new RegExp('^/session/[^/]+/appium/element/:elementId/first_visible')],
  // ['GET', new RegExp('^/session/[^/]+/first_visible_item_id')],
  ['POST', new RegExp('^/session/[^/]+/appium/element/:elementId/scroll_to')]
];
