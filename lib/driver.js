...
const NO_PROXY = [
  ...
  ['GET', new RegExp('^/session/[^/]+/statBarHeight')],
  ['GET', new RegExp('^/session/[^/]+/devicePixelRatio')],
  ['GET', new RegExp('^/session/[^/]+/viewport_screenshot')],
  ['GET', new RegExp('^/session/[^/]+/isScrollable')],
  ['GET', new RegExp('^/session/[^/]+/scrollableViewSize')],
  ['POST', new RegExp('^/session/[^/]+/definiteScrolling')],
  ['GET', new RegExp('^/session/[^/]+/firstVisibleItemFromScrollableView')],
  ['POST', new RegExp('^/session/[^/]+/scrollToId')]
];
