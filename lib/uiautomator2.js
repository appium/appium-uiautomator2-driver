...
const REQD_PARAMS = ['adb', 'tmpDir', 'host', 'systemPort', 'devicePort', 'disableWindowAnimation', 'disableSuppressAccessibilityService'];
...
class UiAutomator2Server {
  ...
  async startInstrumentationProcess (onExit = null) {
    ...
    if (this.disableSuppressAccessibilityService) {
      cmd.push('-e DISABLE_SUPPRESS_ACCESSIBILITY_SERVICES true');
    }
