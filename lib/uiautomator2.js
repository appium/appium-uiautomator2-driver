...
class UiAutomator2Server {
  ...
  async startSession (caps) {
    ...
    while (retries < maxRetries) {
      ...
      try {
        await this.startInstrumentationProcess(timeout, () => {
          didProcessExit = true;
        });
      } catch (e) {
        didProcessExit = true;
  ...
  async startInstrumentationProcess (startupTimeout, onExit = null) {
    ...
    await instrumentationProcess.start(startupTimeout);
  }
